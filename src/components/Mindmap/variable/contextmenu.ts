...
export const addParent: Ref<MenuItem> = ref({ title: '新建父节点', name: 'add-parent', disabled: true })
...
const nodeMenu = computed<MenuItem[][]>(() => [
  [ addItem.value, addParent.value, addSiblingItem.value, addSiblingBeforeItem.value ],
  [ deleteItem.value ],
